...
<body id="www-url-cz">
<!--For general validation of company registration-->
...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Company Registration Form</a></span></h2>
               <div class="login">
...
<!--linking right column and footer page-->
<?php
include "right.php"
?>
