<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="ManageJob.php">Manage intership<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="Application.php">Approve Internship<span class="tab-l"></span><span class="tab-r"></span></a></li>
