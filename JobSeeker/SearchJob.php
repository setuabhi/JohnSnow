...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Search Internship</a></span></h2>
...
?>
                  ...
                  <tr>
                    <td width="100%">&nbsp;
						...
						do { ?>
                          ...
                          <tr>
                          <td><strong>InternshipId</strong></td>
                          ...
                          <td><strong><?php echo $row_Recordset2['Description']; ?></strong></td>
                           ...
                           <tr>
                             <td>&nbsp;</td>
                             <td><a href="Apply.php?JobId=<?php echo $row_Recordset2['JobId'];?>"><strong>Apply For Internship</strong></a></td>
                           </tr>
                        </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Status of Internship</strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699" >
                      <tr>
                        ...
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Internship Title</strong></div></th>
